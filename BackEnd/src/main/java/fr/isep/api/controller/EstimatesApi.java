...
public interface EstimatesApi {
    ...
    ResponseEntity<List<PriceEstimate>> estimatesPriceGet(@NotNull @ApiParam(value = "Latitude component of start location.", required = true) @Valid @RequestParam(value = "start_latitude", required = true) Double startLatitude,@NotNull @ApiParam(value = "Longitude component of start location.", required = true) @Valid @RequestParam(value = "start_longitude", required = true) Double startLongitude,@NotNull @ApiParam(value = "Latitude component of end location.", required = true) @Valid @RequestParam(value = "end_latitude", required = true) Double endLatitude,@NotNull @ApiParam(value = "Longitude component of end location.", required = true) @Valid @RequestParam(value = "end_longitude", required = true) Double endLongitude);
    ...
    @RequestMapping(value = "/estimates/time",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<List<Product>> estimatesTimeGet(@NotNull @ApiParam(value = "Latitude component of start location.", required = true) @Valid @RequestParam(value = "start_latitude", required = true) Double startLatitude,@NotNull @ApiParam(value = "Longitude component of start location.", required = true) @Valid @RequestParam(value = "start_longitude", required = true) Double startLongitude,@ApiParam(value = "Unique customer identifier to be used for experience customization.") @Valid @RequestParam(value = "customer_uuid", required = false) UUID customerUuid,@ApiParam(value = "Unique identifier representing a specific product for a given latitude & longitude.") @Valid @RequestParam(value = "product_id", required = false) String productId);
